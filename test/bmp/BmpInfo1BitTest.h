...
////////////////////////////////////////////////////////////////////////
// Unit test for BmpInfo1Bit

#ifndef BmpInfo1BitTest_h
#define BmpInfo1BitTest_h
...
/////////////////////
class BmpInfo1BitTest : public CPPUNIT_NS::TestCase
{
  CPPUNIT_TEST_SUITE( BmpInfo1BitTest );
...
private:
  BmpInfo1Bit *m_p1x1, *m_p1x2, *m_p2x2, *m_p3x2, *m_p4x2,
              *m_p10x10, *m_p10x20, *m_p20x20, *m_p30x20, *m_p40x20;
};

#endif  // BmpInfo1BitTest_h
