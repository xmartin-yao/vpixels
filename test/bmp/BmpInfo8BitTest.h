...
////////////////////////////////////////////////////////////////////////
// Unit test for BmpInfo8Bit

#ifndef BmpInfo8BitTest_h
#define BmpInfo8BitTest_h
...
/////////////////////
class BmpInfo8BitTest : public CPPUNIT_NS::TestCase
{
  CPPUNIT_TEST_SUITE( BmpInfo8BitTest );
...
private:
  BmpInfo8Bit *m_p1x1, *m_p1x2, *m_p2x2, *m_p3x2, *m_p4x2,
              *m_p10x10, *m_p10x20, *m_p20x20, *m_p30x20, *m_p40x20;
};

#endif  // BmpInfo8BitTest_h
